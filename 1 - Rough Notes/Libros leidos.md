...
### Desarrollo Personal, Sistemas y Creatividad

- **Hábitos atómicos** - James Clear
    
- **Make Time** - Jake Knapp y John Zeratsky
    
- **Outliers (Fueras de serie)** - Malcolm Gladwell
    
- **Roba como un artista** - Austin Kleon
    
- **El arte y la ciencia de no hacer nada** - Andrew Smart
    
- **No puedes dañarme (Can't Hurt Me)** - David Goggins
    
- **Hooked (Enganchado)** - Nir Eyal
    

### Ficción, Distopía y Desarrollo del Ser
...
### Libros Abandonados (Por análisis crítico o estructura)

- **La biblioteca de la medianoche** - Matt Haig _(Estructura repetitiva y falta de profundidad literaria)_
    
- **Deja de ser tú** - Joe Dispenza _(Uso sobresimplificado y pseudocientífico de la física cuántica)_
    
- **Irresistible** - Adam Alter _(Lectura inconclusa)_
